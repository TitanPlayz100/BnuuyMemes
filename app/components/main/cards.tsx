...
export default function Card({ msg }: { msg: Data }) {
  ...
  return (
    <Link href={`/bnuuys/${name.split(".")[0]}`} className='m-1 md:m-3 bg-background-second hover:bg-hoverbg w-[150px] md:w-[200px] transition duration-350 hover:duration-50 p-2'>
