  ...
  return (
    <header className="bg-foreground text-text font-hun flex p-2 pr-4 justify-between bg-[url(/res/header.png)] z-[0]">
      ...
      <div className="hidden md:flex items-center gap-5">
        <Link href="https://github.com/TitanPlayz100/BnuuyMemes" title="GitHub" className="brightness-130 hover:brightness-200 hue-rotate-[var(--hue-shift)]">
          <Image src="/icons/github.svg" alt="github" width={30} height={30} />
        </Link>
        <Link href="/info" title="Info page" className="brightness-130 hover:brightness-200 hue-rotate-[var(--hue-shift)]">
      ...
      <div className="md:hidden flex items-center gap-5">
        <Link href="/info" title="Info page" className="brightness-200 hue-rotate-[var(--hue-shift)]">
          <Image src="/icons/info.svg" alt="info page" width={25} height={25} className="translate-y-1 scale-140" />
        </Link>
